  ...
  return (
    <div>
      <div className="md:hidden flex flex-col justify-center items-center">
        ...
        <div className="bg-matGroen p-4 space-y-4 w-full h-auto">
      ...
      <div className="hidden md:block relative h-[700px] w-full ">
        ...
        <div className="  px-4 lg:px-8 max-w-screen-2xl mx-auto">
          <div className="absolute bg-matGroen p-4 space-y-4 w-full md:w-1/2 h-auto top-1/2 left-800 transform -translate-y-1/2 max-w-3xl">
            <h1 className="text-3xl text-kobalt font-medium">
              Advance Your Carer with our Coprehensive Courses
            </h1>
            <p className="text-lg text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente
              aut esse nostrum magni laboriosam. Repellat, illo praesentium?
              Culpa ipsa quibusdam quod deserunt facilis sequi beatae unde
              atque, fuga iusto amet eligendi doloribus nostrum esse excepturi
              similique sit dolore officiis labore? Dolorum laboriosam inventore
              exercitationem eligendi, ipsam officiis. Facilis, molestias
              laboriosam?
            </p>
          </div>
        </div>
